...
import com.ticketease.api.DTO.UnitCreateDTO;
import com.ticketease.api.Entities.Unit;
import com.ticketease.api.Repositories.UnitRepository;
...
public class UnitController {
  ...
  public ResponseEntity<?> updateUnit(
      @PathVariable Long unitID, @RequestBody UnitCreateDTO unitCreateDTO) {
    Optional<Unit> optionalUnit = unitRepository.findById(unitID);
