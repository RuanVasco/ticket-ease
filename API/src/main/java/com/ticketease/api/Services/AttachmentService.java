...
public class AttachmentService {
  ...
  public void init() {
    ...
    if (!dir.exists() && !dir.mkdirs()) {
      throw new IllegalStateException(
          "Não foi possível criar a pasta de uploads: " + dir.getAbsolutePath());
    }
  ...
  public void saveAttachments(FormFieldFileAnswerDTO fileAnswers, Ticket ticket) {
    ...
    for (MultipartFile file : fileAnswers.getFiles()) {
      ...
      String extension =
          contentType != null && contentType.contains("/")
  ...
  public Resource getAttachmentsByTicket(Ticket ticket, String attachmentName) {
          ...
          if (attachment.getFileName().equals(attachmentName)) {
            try {
              ...
              throw new RuntimeException(
                  "Erro ao carregar o arquivo: " + attachment.getFileName(), e);
            }
          }
        }
      }
    ...
    throw new ResponseStatusException(
        HttpStatus.NOT_FOUND, "Nenhum anexo encontrado para este ticket.");
  }
}
